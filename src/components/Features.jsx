        ...
        <section className='h-full common-padding bg-zinc relative overflow-hidden' >
            <div className="screen-max-width">
                ...
                <div className="flex flex-col justify-center items-center overflow-hidden">
                    ...
                    <div className="flex-center flex-col sm:px10">
                        <div className="relative h-[50vh] w-full flex items-center">
                            <video playsInline id='exploreVideo' className='w-full h-full object-cover object-center' muted preload='none' autoPlay ref={videoRef} >
                        ...
                        <div className="flex flex-col w-full relative">
                            ...
                            <div className="feature-text-container">
                                ...
                                <div className="flex-1 flex-center">
                                    <p className="feature-text g_text">Titanimum has one of the best strength-to-weigth ratios of any metal, making these our  {' '}
